...
const Footer = () => {
    return (
        <section className="bg-black text-white py-6">
            <div className="w-container_width mx-auto grid grid-cols-3 gap-14">
                <div>
                    <div>
                        <img
                    ...
                    <p className="py-4 text-gray-200">
                        Welcome to the lufumart.com website operated within DRC
                        Congo & Kenya. We respect your privacy and want to
                        protect your personal information. To learn more, please
